...
export default function SidebarGuru() {
    ...
    const handleDropdownKuisClick = () => {
        setIsKuisOpen(!isKuisOpen);
    };

    const handleDropdownMateriClick = () => {
        ...
        <div className="fixed left-0 w-60 py-10 rounded-r-3xl h-screen bg-white shadow-custom flex flex-col justify-between">
            <div className="h-4/5">
                ...
                <div className="overflow-y-auto h-[70%]">
                    ...
                    <ul className="*:text-lg *:font-semibold *:h-14 *:pl-12 mb-8">
                        ...
                        <button
                            className={`flex items-center w-full hover:bg-primary-light hover:text-white ${
                                url.includes("/materi") ||
                                url.includes("/submateri")
                                    ? "bg-primary text-white"
                                    : ""
                            }`}
                            onClick={handleDropdownMateriClick}
                    ...
                    <p className="text-xl font-semibold mb-3 pl-12">
                        Penilaian
                    </p>
                    <ul className="*:text-lg *:font-semibold *:h-14 *:pl-12">
                        <button
                            ...
                            onClick={handleDropdownKuisClick}
