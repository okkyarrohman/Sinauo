        ...
        <div class="row h-100">
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h2 class="auth-titlle">Selamat Datang</h2>
                    <p class="auth-subtitlle ">Masuk dan Mulai Belajar Bersama SinauO!</p>
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Belum Punya Account? <a href="/register"
